...
trees: [
  { species: "Poison Nut Tree", count: "NA" },
  { species: "Indian Gooseberry", count: "NA" },
  { species: "Mountain Ebony", count: "NA" },
  { species: "Java Plum", count: "NA" },
  { species: "Indian Gum Arabic Tree", count: "NA" },
  { species: "Black Catechu", count: "NA" },
  { species: "White Bark Acacia", count: "NA" },
  { species: "Common Bamboo", count: "NA" },
  { species: "Sacred Fig", count: "NA" },
  { species: "Alexandrian Laurel", count: "NA" },
  { species: "Banyan Tree", count: "NA" },
  { species: "Flame of the Forest", count: "NA" },
  { species: "Oleander", count: "NA" },
  { species: "Cluster Fig", count: "NA" },
  { species: "Bael Tree", count: "NA" },
  { species: "Arjun Tree", count: "NA" },
  { species: "Wood Apple", count: "NA" },
  { species: "Spanish Cherry", count: "NA" },
  { species: "Toothbrush Tree", count: "NA" },
  { species: "Golden Shower Tree", count: "NA" },
  { species: "Indian Willow", count: "NA" },
  { species: "Jackfruit Tree", count: "NA" },
  { species: "Crown Flower", count: "NA" },
  { species: "Teak", count: "NA" },
  { species: "Khejri Tree", count: "NA" },
  { species: "Kadam Tree", count: "NA" },
  { species: "Mango Tree", count: "NA" },
  { species: "Clearing Nut Tree", count: "NA" },
  { species: "Neem Tree", count: "NA" },
  { species: "Mahua Tree", count: "NA" },
]
